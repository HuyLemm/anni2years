...
const Prize2 = () => {
  ...
  const closePopup = () => {
    const currentMessage = messages.find(
      (msg, index) =>
        (index === 3 && activePopup === "love") ||
        (index === 4 && activePopup === "photo") ||
        (index === 5 && activePopup === "story")
    );
      ...
      {showBoard && (
        ...
        >
          ...
          >
            ...
            {completedSteps.love ? "Nhờ ân nhân hỏi như nào zị taa ❤️" : "🔒"}
          </p>
          <p
            onClick={() =>
          ...
          >
            ...
            {completedSteps.photo ? "Vợ có một vé đi lựa nhẫn ùi nè❤️" : "🔒"}
          </p>
          <p
            onClick={() =>
          ...
          >
            ...
            {completedSteps.story ? "Ngày kỉ niệm toẹt zời 😻" : "🔒"}
          </p>
        </motion.div>
      )}
      {renderPopup()}
