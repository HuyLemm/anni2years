...
const Prize6 = () => {
  ...
  const closePopup = () => {
    const currentMessage = messages.find(
      (msg, index) =>
        (index === 15 && activePopup === "love") ||
        (index === 16 && activePopup === "photo") ||
        (index === 17 && activePopup === "story")
    );
      ...
      {showBoard && (
        ...
        >
          ...
          >
            ...
            {completedSteps.love ? "Sụp pơ sai yan abalababui ☺" : "🔒"}
          </p>
          <p
            onClick={() =>
          ...
          >
            ...
            {completedSteps.photo ? "Vợ có một vé đi siu thị ùi nè❤️" : "🔒"}
          </p>
          <p
            onClick={() =>
          ...
          >
            ...
            {completedSteps.story ? "Give me your worddsdssds!!!! 👉👈" : "🔒"}
          </p>
        </motion.div>
      )}
      {renderPopup()}
