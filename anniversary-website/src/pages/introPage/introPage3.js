...
const Intro3 = () => {
  ...
  const handleDoorClick = () => {
    if (doorClickable) {
      // Chỉ cho phép cửa được ấn sau khi chat xuất hiện
      setDoorClicked(true);
    ...
    >
      ...
      <>
        ...
        <img
          ...
          style={{ top: "70px", left: "370px", width: "600px", zIndex: 2 }}
        />
        <img
          src={flower}
          alt="flower"
          className="absolute center"
          style={{ top: "240px", left: "20px", width: "400px", zIndex: 2 }}
        />
        ...
        <img
          ...
          alt="Road"
          className="absolute center"
          style={{ left: "-100px", width: "1500px", zIndex: 1 }}
        />
        <img
          src={road}
          alt="Road"
          className="absolute center"
          style={{ left: "60px", width: "1500px", zIndex: 1 }}
        />
        <img
          src={square}
          alt="square"
          className="absolute center"
          style={{ right: "330px", width: "200px", zIndex: 1 }}
        />
        ...
        {showUs && (
          <img
            ...
            alt="us"
            className="absolute center"
            style={{ top: "370px", right: "370px", width: "130px", zIndex: 3 }}
          />
        )}
        ...
        <img
          ...
          className={`absolute center cursor-pointer ${
            doorClickable ? "opacity-100" : "opacity-50"
          }`} // Chỉ cho phép click khi chat xuất hiện
