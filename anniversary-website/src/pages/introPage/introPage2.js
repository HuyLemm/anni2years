  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{ top: "80px", left: "20px", width: "400px", zIndex: 2 }}
      />
      <img
        src={house2}
        alt="house2"
        className="absolute center"
        style={{ top: "140px", right: "20px", width: "600px", zIndex: 2 }}
      />
      <img
        src={playground}
        alt="playground"
        className="absolute center"
        style={{ top: "580px", left: "40px", width: "400px", zIndex: 2 }}
      />
      <img
        src={green}
        alt="green"
        className="absolute center"
        style={{ top: "540px", left: "-15px", width: "500px", zIndex: 1 }}
      />
      <img
        src={picnic}
        alt="picnic"
        className="absolute center"
        style={{ top: "600px", right: "-15px", width: "600px", zIndex: 1 }}
      />
      ...
      <img
        ...
        alt="Road"
        className="absolute center"
        style={{ left: "-530px", width: "1500px", zIndex: 1 }}
      />
      <img
        src={road}
        alt="Road"
        className="absolute center"
        style={{ right: "-510px", width: "1500px", zIndex: 1 }}
      />
      <img
        src={road}
        alt="Road"
      ...
      <img
        ...
        alt="square"
        className="absolute center"
        style={{ left: "800px", width: "200px", zIndex: 1 }}
      />
      ...
      <motion.img
        ...
        style={{
          ...
          width: "150px",
          zIndex: 2,
          display: startPhase2 ? "none" : "block",
        }}
      ...
      {showChat === "alvin-start" && (
        ...
        >
          ...
          <p
            className="absolute text-center text-pink-700 ml-12"
            style={{
              top: "52%",
      ...
      {showChat === "think" && (
        ...
        >
          ...
          <p
            className="absolute text-center text-pink-700 ml-10"
            style={{ top: "63px", fontFamily: "Boris", fontSize: "21px" }}
          >
            Mình nên đi tiếp <br />
            hay dừng lại đây ta?🫤
          </p>
          ...
          >
            <button
              ...
              className=" bg-green-500 text-white rounded-full text-center "
              style={{
                padding: "7px 20px",
              }}
            >
            ...
            <button
              onClick={handleStop}
              className="px-4 py-1 bg-red-500 text-white rounded-full text-center  "
            >
              Dừng lại
            </button>
          </div>
      ...
      {showChat === "paoi-continue" && (
        ...
        >
          <img
            src={chatpaoi}
            alt="Chat Paoi Continue"
            style={{ width: "100%" }}
          />
          <p
            className="absolute text-center text-pink-700 ml-16"
            style={{ top: "80px", fontFamily: "Boris", fontSize: "21px" }}
          >
            Mình cứ đi tiếp
            <br /> đi anhhh, sợ gìii! <br />
            😝
          </p>
        </motion.div>
      )}
      ...
      {showChat === "paoi-stop" && (
        ...
        >
          ...
          <p
            className="absolute text-center text-pink-700 ml-10"
            style={{ top: "100px", fontFamily: "Boris", fontSize: "21px" }}
          >
      ...
      {showChat === "alvin-stop" && (
        ...
        >
          <img src={chatalvin} alt="Chat Alvin" style={{ width: "100%" }} />
          <p
            className="absolute text-center text-pink-700 ml-20"
            style={{
              top: "52%",
              transform: "translateY(-50%)",
              fontFamily: "Boris",
