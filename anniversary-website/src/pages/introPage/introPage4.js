        ...
        <>
          ...
          >
            ...
            <p
              ...
              style={{ top: "454px", fontFamily: "TAN", fontSize: "30px" }}
            >
              Hots
            </p>
            <p
              className="absolute text-center text-pink-700 ml-24"
              style={{ top: "477px", fontFamily: "TAN", fontSize: "24px" }}
            >
      ...
      {showSecondImages && (
        <>
          ...
          >
            ...
            <p
              className="absolute text-center text-pink-700 ml-24"
              style={{ top: "165px", fontFamily: "Boris", fontSize: "21px" }}
            >
              Paoi mún cứu Alvin <br /> thì hãy dùng ngôi sao <br /> hi vọng
              phía dưới nhooo😉
            </p>
          </motion.div>
        </>
